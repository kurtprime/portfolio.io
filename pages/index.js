...
const Home = () => {
  return (
    <div className="bg-primary/60 w-full min-h-screen">
      {/* text */}
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10   ">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left min-h-screen container mx-auto  ">
          {/* title */}
          <motion.h1
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0  ">
        ...
        <motion.div
          ...
          className="w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-32 lg:bottom-[-100px] lg:right-[8%]  "
        >
          <Avatar />
        </motion.div>
      </div>
